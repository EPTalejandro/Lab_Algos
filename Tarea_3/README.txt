...
Ventas y Analisis ventas:
    -Comenzamos con la clase Ventas cuyos objetos tendran tres atributos(producto, precio, cantidad) siendo atributos únicos para cada objeto y la clase 
    Ventas cuenta con diferentes metodos para retribuir dichos elementos.

    - Despues esta la clase analisisVentas la cual maneja una lista de todas las ventas realizas, luego tiene diferentes métodos que interactuan
    ...
    Los métodos de AnalisisVentas son:
    *nuevaVenta: Registra la nueva venta como objeto Venta y lo guarda en la lista de todas las ventas.
    *ingresoProducto: Dado el nombre de un producto Retorna el ingreso total que ha dejado un producto tomando en cuenta unidades vendidas y precio unitario.
    ...
    *cantidadVendida: Retorna el total de unidades vendidas de un producto dado.
    *ingresoProductoMayorQue: Retorna una lista con todos los productos que hayan dejado un ingreso mayor a una suma dada.
